...
//! every sycophant capability-job pod needs so the controllers that spawn them
//! can't drift.
...
/// `VolumeMount` pair a capability-job pod mounts at the kubelet default path. The
