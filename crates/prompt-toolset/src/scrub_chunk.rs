...
use toolset_proto::content_block::Block;
...
mod tests {
    ...
    const SCRUB_ENV: &str = "TEST_TOOLSET_SCRUB";
                ...
                Chunk::Complete(complete) => {
                    for cb in &complete.content {
                        match cb.block.as_ref().unwrap() {
                            ...
                            content_block::Block::Image(_) | content_block::Block::File(_) => {}
                        }
                    }
                }
