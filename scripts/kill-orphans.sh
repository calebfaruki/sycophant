...
patterns=(
  "while true.*kubectl.*port-forward.*(hangar-ctrl|headscale|airlock-ctrl|mainframe-ctrl|e2e-test)"
  "kubectl.*port-forward.*(hangar-ctrl|headscale|airlock-ctrl|mainframe-ctrl|e2e-test)"
